                            ...
                            <div class="aa-product-inner">
                              <!-- Bank -->
                                <ul class="nav nav-tabs aa-products-tab">
                                    <li class="active"><a href="#men" data-toggle="tab">WESTERN UNION</a></li>
                                </ul>
                              <!-- /Bank -->
                              ...
                              <div class="div-input">
                                <form action="/action_page.php">
                                    ...
                                    <input type="text" id="lname" name="lastname" placeholder="Address Line 1..">
                                    ...
                                    <input type="text" id="lname" name="lastname" placeholder="City/Town..">
                                    ...
                                    <input type="text" id="lname" name="lastname" placeholder="Zip Code..">
