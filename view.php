              ...
              <div class="aa-header-top-area">
                ...
                <div class="aa-header-top-left">
                  ...
                  <div class="aa-currency">
                    <div class="dropdown">
                      <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="fa fa-usd"></i> Balence </a>
                    </div>
                  </div>
                  <div class="aa-currency">
                    <div class="dropdown">
                      <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <i class="fa fa-usd"></i> Balence Pending
                      </a>
                    </div>
                  </div>
                  <!-- / currency -->
            ...
            <div class="col-md-12">
              <div class="aa-header-bottom-area">
                ...
                <div class="aa-logo">
                  ...
                  <!-- img based logo -->
                  <a href="index.html"><img src="img/logo.png" style="width: 67%" alt="logo img" /></a>
                </div>
                <!-- / logo  -->
                <!-- cart box -->
          ...
          <div class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-collapse collapse">
              ...
              <ul class="nav navbar-nav">
                ...
                <li>
                  <a href="#">MOBILE<span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="#">Pubg Mobile</a></li>
                    <li><a href="#">Mobile Lagends</a></li>
                    <li><a href="#">Free Fire</a></li>
                    <li><a href="#">Clash Of Clans</a></li>
                    <li><a href="#">Call Of Dutty Mobile</a></li>
                    <li><a href="#">League Of lagends</a></li>
                    <li><a href="#">Genshin Impact</a></li>
                  </ul>
                </li>
                <li>
                  <a href="#">PC<span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="#">Pubg</a></li>
                    <li><a href="#">Fortnite</a></li>
                    <li><a href="#">Dota</a></li>
                    <li><a href="#">Apex Lagends</a></li>
                    <li><a href="#">Pes</a></li>
