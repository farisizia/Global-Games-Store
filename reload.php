                            ...
                            <div class="row">
                              ...
                              <div class="col-6">
                                <div class="input-group">
                                  <input type="password" name="cvcpwd" placeholder="&#9679;&#9679;&#9679;" class="placeicon" minlength="3" maxlength="3" /> <label>CVV</label>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <form action=" " method="post" >  
                             <div class="col-md-12"><button  class="btn btn-primary placeicon"   name="reload"> Reload</button></div>
                             </form>
                            </div>
                            <div class="row">
                              <div class="col-md-12">
