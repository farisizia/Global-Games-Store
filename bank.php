                        ...
                        <div class="aa-product-area">
                            ...
                            <div class="div-input">
                                <form action="/action_page.php">
                                    ...
                                    <input type="text" id="fname" name="firstname" placeholder="BB Bank..">

                                    <label for="fname">Beneficiary Name</label>
                                    <input type="text" id="fname" name="firstname" placeholder="John Smith..">

                                    <label for="lname">Swift Code</label>
                                    <input type="text" id="lname" name="lastname" placeholder="ABCDAB1S..">
