...
$topup = mysqli_query($conn,"SELECT * FROM topups WHERE invoice = '$invoice' LIMIT 1");
...
if( isset($_POST['check_pembayaran'])){
    if(checkStatusTopup($invoice) > 0) {
        echo "<script>
        alert('Status berubah menjadi '.$invoice.'');
        document.location.href = 'invoice-topup.php?invoice=".$invoice."';
      </script>";
    } else {
      echo "<script>
        alert('Belum terjadi perubahan status topup');
      </script>";
    }
  }
?>
                ...
                <div class="panel panel-default invoice" id="invoice">
                    <div class="panel-body">
                        <div class="invoice-ribbon">
                            <div class="ribbon-inner" style="text-transform: uppercase;"><?php echo $status ?>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6 top-right">
                                ...
                                <span class="marginright"><?= $created_at ?></span>
                            </div>
                        </div>
                        <hr />
                        <div class="row">
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right" style="width: 15%">Link Pembayaran</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="<?= $checkout_url ?>" target="_blank" class="btn btn-primary"> <i
                        ...
                        <div class=" row">
                            <div class="col-xs-6 margintop">
                                ...
                                <form method="POST" action="">
                                    ...
                                    <a href=" print.php?id_product=<?= $id_product ?>" target="_blank"
                                        ...
                                        Invoice</a>
                                    <button type="submit" class="btn btn-secondary" name="check_pembayaran"
                                        id="check_pembayaran" value="check_pembayaran"><i class="fa fa-check"></i> Cek
                                        Pembayaran</button>
                                </form>
                            ...
                            <div class="col-xs-6 text-right pull-right invoice-total">
                                <p>Subtotal : Rp <?php echo number_format($amount) ?></p>
