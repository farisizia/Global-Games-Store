...
$products = mysqli_query($conn,"SELECT * FROM product WHERE id_product = $id_product");
...
$title = $product['title'];
$price = $product['price'];
$id_platforms = $product['id_platforms'];
$id_game = $product['id_game'];
        ...
        <section id="aa-product">
            <div class="container">
                <ul class="nav nav-tabs aa-products-tab">
                    <li class="active"><a href="#men" data-toggle="tab">Edit Your listing-Products</a></li>
                </ul>

                <div class="form-group">
                    <label for="exampleFormControlInput1">listing Title</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="title" value="<?php echo $title ?>">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Price</label>
                    <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="$"  name="price" value="<?php echo $price ?>"> 
                    <input type="text" class="form-control" id="exampleFormControlInput1"name="id_product" value="<?php echo $id_product ?>">
                </div>
    ...
    <select class="form-control" id="exampleFormControlSelect1" name="id_game">
      ...
      <?php endwhile; ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Include the most important information about your listing here" name="description"><?php echo $description ?></textarea>
                </div></br>
                ...
                <div>
                   <button class="btn btn-success btn-lg"  role="button" name="update_product">Update Now</button>
                </div>
